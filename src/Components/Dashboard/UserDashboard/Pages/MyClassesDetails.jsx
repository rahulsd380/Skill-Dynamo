...
const MyClassesDetails = () => {
    ...
    const handleSubmitAssignment = (e) => {
      ...
      const allData = { assignmentTitle, assignmentDeadline, assignmentDescription};
    ...
    return (
        ...
        <div className="flex items-center gap-5 mb-7">
                ...
                <h1 className="bg-gradient-to-br from-sky-500  to-sky-800 bg-clip-text text-transparent font-bold text-4xl">Class Progress</h1>
                </div>
        <div className="bg-gradient-to-r from-blue-900 via-blue-950 to-blue-950 p-4 rounded-xl w-full">
            ...
            <div className="grid grid-cols-2 gap-8 px-7">
                <div className="bg-blue-900 p-3 rounded-md">
                    ...
                    <h1 className="text-xl font-semibold text-gray-200 text-center">Total Enrollment</h1>
                    <p className="text-blue-400 text-center text-lg font-semibold"><CountUp end={2000} duration={5}/>+</p>
                </div>
                <div className="bg-blue-900 p-3 rounded-md">
                <div className="flex justify-center items-center"><MdOutlineAssignment className="text-6xl font-bold text-blue-400 text-center"></MdOutlineAssignment></div>
                    <h1 className="text-xl font-semibold text-gray-200 text-center">Total Assignment</h1>
                    <p className="text-blue-400 text-center text-lg font-semibold"><CountUp end={999} duration={5}/>+</p>
                </div>
                <div className="bg-blue-900 p-3 rounded-md">
                <div className="flex justify-center items-center"><FaPercent className="text-5xl mb-2 font-bold text-blue-400 text-center"></FaPercent></div>
                ...
                <div className="bg-blue-900 p-3 rounded-md">
                <div className="flex justify-center items-center"><MdAssignmentTurnedIn className="text-6xl font-bold text-blue-400 text-center"></MdAssignmentTurnedIn></div>
                    <h1 className="text-xl font-semibold text-gray-200 text-center">Assignment Submited</h1>
...
<button className="text-gray-200 font-semibold px-4 py-2 bg-gradient-to-r from-sky-500 to-sky-800 rounded-md w-full text-center" onClick={()=>document.getElementById('my_modal_1').showModal()}>Add Assignment</button>
<dialog id="my_modal_1" className="modal">
  <div className="modal-box bg-gradient-to-r from-blue-900 via-blue-900 to-blue-950">
    <h3 className="font-bold text-lg text-blue-400 mb-6">Add Assignment</h3>
   ...
   <div className="relative h-11 w-full">
      ...
      <div className="relative h-32 w-full mt-7">
       ...
       <button className="text-gray-200 font-semibold px-4 py-2 bg-gradient-to-r from-sky-600 to-sky-800 rounded-md w-full text-center mt-5">Add Assignment</button>
